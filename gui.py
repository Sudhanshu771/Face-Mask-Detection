...
my_label.grid(row=0,column=0,columnspan=6,rowspan=24)

buttonFont = font.Font(family='Helvetica', size=16, weight='bold')

btn1 = Button(root, text="Image Upload", command=image, padx=40, pady=20, bg='#6DD4EE', fg='#2D2E34', font=buttonFont)
btn2 = Button(root, text=" Live Video ", command=video, padx=40, pady=20, bg='#6DD4EE', fg='#2D2E34', font=buttonFont)

btn1.grid(row=23, column=0, pady=15)
btn2.grid(row=23, column=5, pady=15)
